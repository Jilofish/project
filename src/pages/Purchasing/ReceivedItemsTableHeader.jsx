...
function ReceivedItemsTableHeader({
    ...
    return (
        <div className="flex items-center justify-between flex-wrap">
            <h1 className="text-black/80 dark:text-white text-lg lg:text-2xl font-bold">Received Products</h1>
            ...
            <div className = "flex items-center gap-3">
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    <button 
                        onClick={onAddReceivedItemClick}
                        ...
                        <span className="text-xs lg:text-sm font-medium">Add <span className = "hidden md:inline">Receiving</span></span>
                    </button>
                </div>
            </div>
