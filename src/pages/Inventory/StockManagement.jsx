...
import CustomerListTable from '../Sales/CustomerListTable';
...
function StockManagement() {
    ...
    const getTabClasses = (tabId) => 
        activeTab === tabId 
            ? "inline-block p-4 border-b-2 border-blue-500 text-slate-600 dark:text-slate-400 font-semibold cursor-pointer"
                ...
                <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
                    ...
                    <li className="me-2" role="presentation">
                        <button 
                            ...
                            className={getTabClasses('profile hover:cursor-pointer')} 
                            id="profile-tab" 
                            type="button" 
                            role="tab" 
                    ...
                    <li className="me-2" role="presentation">
                        <button 
                            ...
                            className={getTabClasses('dashboard hover:cursor-pointer')} 
                            id="dashboard-tab" 
                            type="button" 
                            role="tab" 
