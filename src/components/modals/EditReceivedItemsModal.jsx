...
function EditReceivedItemsModal({ isOpen, onClose, itemData, onSave }) {
   ...
   const handleDeliver = async () => {
        try {
            ...
            `/api/received-items/${formData.purchased_order_id}/deliver`,
            { method: 'PUT' }
            );
    ...
    return (
        <div className="fixed inset-0 bg-black/40 z-40 flex items-center justify-center p-4">
            <div
                className="w-full max-w-2xl bg-white dark:bg-slate-800 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto py-5 space-y-8 px-7">
                    ...
                    <div className="overflow-x-auto pb-3">
                        ...
                        <table className="w-full">
                            ...
                            <tbody className = "dark:text-white/80 border-b border-slate-300 dark:border-slate-600">
                                {formData && (
                                <tr>
