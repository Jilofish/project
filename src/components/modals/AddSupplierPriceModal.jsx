   ...
   if (!isOpen) return null;
    return (
        <div className="fixed inset-0 bg-black/60 z-[60] flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} id = "addSupplierPriceForm" className="p-6 space-y-5">
                    <CustomFormSelect 
                ...
                <div className="p-5 flex justify-end space-x-3 border-t border-slate-300 dark:border-slate-700 flex-shrink-0">
                    ...
                    <button type="submit" form = "addSupplierPriceForm" className="px-6 py-2 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 cursor-pointer transition-colors">
                        Add to List
                    </button>
                </div>
            </div>
